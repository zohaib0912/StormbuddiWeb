        ...
        <div className="container mx-auto px-4 pt-32 pb-12 md:pt-32 md:pb-14">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-[#A83119] to-[#D1452A] rounded-2xl mb-6 shadow-lg">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-[#042D43] mb-4">
                Privacy Policy
              </h1>
              <p className="text-[#4C6371] text-lg">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <section>
                <div className="flex items-start gap-4 mb-6">
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#A83119] to-[#D1452A] rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Introduction</h2>
              ...
              <section>
                <div className="flex items-start gap-4 mb-6">
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#042D43] to-[#1a4a6b] rounded-lg flex items-center justify-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-6">Information We Collect</h2>
                    
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 mb-6">
                      <h3 className="text-xl font-semibold text-[#042D43] mb-4 flex items-center gap-2">
                      ...
                      <ul className="space-y-3 mb-4">
                        {[
                          ...
                          <li key={idx} className="flex items-start gap-3 text-[#4C6371]">
                            <span className="flex-shrink-0 w-6 h-6 bg-[#A83119] rounded-full flex items-center justify-center mt-0.5">
                      ...
                      <p className="text-[#4C6371] leading-relaxed mb-4 font-semibold">
                      ...
                      <div className="grid md:grid-cols-2 gap-3">
                        {[
                          ...
                          <div key={idx} className="flex items-start gap-2 text-[#4C6371]">
              ...
              <section>
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-6">How We Use Your Information</h2>
                    <p className="text-[#4C6371] leading-relaxed mb-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {[
                        ...
                        <div key={idx} className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200 hover:border-[#A83119] transition-colors">
                          <h4 className="font-semibold text-[#042D43] mb-2">{item.title}</h4>
                          <p className="text-sm text-[#4C6371]">{item.desc}</p>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <section>
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Information Sharing and Disclosure</h2>
                    <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl p-6 mb-6 border-l-4 border-[#A83119]">
                      <p className="text-[#042D43] font-semibold mb-4 text-lg">
                    ...
                    <ul className="space-y-4">
                      {[
                        ...
                        <li key={idx} className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                          <div className="flex-shrink-0 w-8 h-8 bg-[#A83119] rounded-lg flex items-center justify-center text-white font-bold">
                            {idx + 1}
                          </div>
                          <div>
                            <h4 className="font-semibold text-[#042D43] mb-1">{item.title}</h4>
                            <p className="text-[#4C6371] text-sm">{item.desc}</p>
                          </div>
                        </li>
                      ))}
                    </ul>
              ...
              <section>
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Data Security</h2>
                    <p className="text-[#4C6371] leading-relaxed mb-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mb-6">
                      {[
                        ...
                        <div key={idx} className="flex items-center gap-3 p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border border-green-200">
                          ...
                          <span className="text-[#4C6371]">{item}</span>
                        </div>
                      ))}
                    </div>
                    <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-lg p-4">
                      <p className="text-[#4C6371] leading-relaxed text-sm">
              ...
              <section>
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Your Rights and Choices</h2>
                    <p className="text-[#4C6371] leading-relaxed mb-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mb-6">
                      {[
                        ...
                        <div key={idx} className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-4 border border-blue-200 hover:border-[#A83119] transition-colors">
                          <h4 className="font-semibold text-[#042D43] mb-2 flex items-center gap-2">
                            <span className="w-2 h-2 bg-[#A83119] rounded-full"></span>
                            {item.title}
                          </h4>
                          <p className="text-sm text-[#4C6371]">{item.desc}</p>
                    ...
                    <div className="bg-gradient-to-br from-[#042D43] to-[#1a4a6b] rounded-lg p-4 text-white">
                      <p className="text-sm">
              ...
              <section>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Cookies and Tracking Technologies</h2>
                    <p className="text-[#4C6371] leading-relaxed mb-4">
              ...
              <section>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Third-Party Links</h2>
                    <p className="text-[#4C6371] leading-relaxed">
              ...
              <section>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Children's Privacy</h2>
                    <p className="text-[#4C6371] leading-relaxed">
              ...
              <section>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Changes to This Privacy Policy</h2>
                    <p className="text-[#4C6371] leading-relaxed">
              ...
              {/* Contact Us */}
              <section className="bg-gradient-to-br from-[#042D43] to-[#1a4a6b] rounded-xl shadow-xl p-8 md:p-10 text-white">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 space-y-4">
                      <div className="flex items-start gap-4">
                        <div className="flex-shrink-0 w-10 h-10 bg-[#A83119] rounded-lg flex items-center justify-center">
                        ...
                        <div>
                          <p className="font-semibold mb-1">StormBuddi</p>
                          <p className="text-sm opacity-90">2785 Rockbrook Dr Suite 104</p>
                          <p className="text-sm opacity-90">Lewisville, Texas, United States of America</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        ...
                        <a href="tel:+14693069209" className="text-[#E9BD80] hover:text-[#f4d4a3] transition-colors font-medium">
                          +1 469 306 9209
                        </a>
                      </div>
                      <div className="flex items-center gap-4">
                        ...
                        <a href="mailto:info@stormbuddi.com" className="text-[#E9BD80] hover:text-[#f4d4a3] transition-colors font-medium">
                          info@stormbuddi.com
                        </a>
                      </div>
                    </div>
