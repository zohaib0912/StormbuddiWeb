            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <section>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Subscription Services</h2>
                    <p className="text-[#4C6371] leading-relaxed mb-4">
              ...
              <section>
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-6">Refund Policy</h2>
                      ...
                      <ul className="space-y-3">
                        {[
                          ...
                          <li key={idx} className="flex items-start gap-3 text-[#4C6371]">
                            <span className="flex-shrink-0 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 mb-6">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {[
                          ...
                          <div key={idx} className="bg-white rounded-lg p-4 border border-gray-200 hover:border-[#A83119] transition-colors">
                    ...
                    <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl p-6 border-l-4 border-red-400">
                      ...
                      <ul className="space-y-2">
                        {[
                          ...
                          <li key={idx} className="flex items-start gap-2 text-[#4C6371]">
              ...
              <section>
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-6">Cancellation Policy</h2>
                    
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 mb-6">
                      <h3 className="text-xl font-semibold text-[#042D43] mb-4">How to Cancel</h3>
                      <p className="text-[#4C6371] leading-relaxed mb-4">
                    ...
                    <div className="space-y-4">
                      <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-400">
                        <h3 className="text-lg font-semibold text-[#042D43] mb-2">Monthly Subscriptions</h3>
                        <p className="text-[#4C6371] text-sm">
                      ...
                      <div className="bg-green-50 rounded-lg p-4 border-l-4 border-green-400">
                        <h3 className="text-lg font-semibold text-[#042D43] mb-2">Annual Subscriptions</h3>
                        <p className="text-[#4C6371] text-sm">
              ...
              <section>
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-6">Refund Process</h2>
                    
                    <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-6 mb-6">
                      <h3 className="text-xl font-semibold text-[#042D43] mb-4">How to Request a Refund</h3>
                      <p className="text-[#4C6371] leading-relaxed mb-4">
                      ...
                      <ol className="space-y-4">
                        {[
                          ...
                          <li key={idx} className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <h4 className="font-semibold text-[#042D43] mb-1">{item.step}</h4>
                              <p className="text-sm text-[#4C6371]">{item.detail}</p>
                            </div>
                          </li>
                        ))}
                      </ol>
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6">
                      <h3 className="text-xl font-semibold text-[#042D43] mb-4">Refund Processing Time</h3>
                      <p className="text-[#4C6371] leading-relaxed mb-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {[
                          ...
                          <div key={idx} className="flex items-start gap-3 p-3 bg-white rounded-lg">
                            ...
                            <span className="text-sm text-[#4C6371]">{item}</span>
                          </div>
                        ))}
                      </div>
                    </div>
              ...
              <section>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Account Access After Refund</h2>
                    <p className="text-[#4C6371] leading-relaxed mb-4">
              ...
              <section>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Chargebacks</h2>
              ...
              <section>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#042D43] mb-4">Changes to This Policy</h2>
                    <p className="text-[#4C6371] leading-relaxed">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 space-y-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <p className="font-semibold mb-1">StormBuddi Support</p>
                      ...
                      <div className="pt-4 border-t border-white/20">
                        <p className="text-sm opacity-90">Business Hours: Monday - Friday, 9:00 AM - 6:00 PM CST</p>
                      </div>
                    </div>
                  </div>
                </div>
